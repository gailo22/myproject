...
public class ExpressionTree {
	...
	public ExpressionTree(String postfix) {
		if (postfix == null) {
			throw new IllegalArgumentException("The posfix should not be null");
		}
		if (postfix.length() == 0) {
			throw new IllegalArgumentException(
					"The postfix should not be empty");
		}
	...
	public String prefix() {
		if (root == null) {
			throw new NoSuchElementException(
					"The root is empty, the tree has not yet been constructed.");
		}
